    ...
    <div class="profile-form form">
        <form action="#" method="get">
            <div class="upload-img">
                <input type="hidden">
                <figure>
                    <img src="assets/images/img-after-upload.png" alt="" srcset="">
                    <img src="assets/images/upload-img.svg" alt="" srcset="">
                </figure>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <input type="email" class="form-control custom-input" name="email" id="email" placeholder="أدخل البريد الالكتروني">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="icon-input">
                            ...
                            <input type="text" class="form-control custom-input" name="number_phone" id="number_phone" placeholder="أدخلرقم الجوال">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="icon-input">
                            ...
                            <input type="password" class="form-control custom-input" placeholder="أدخل كلمة المرور">

                            <span class="icon-i-2 cursor-pointer">
                                <a href="#" class="red-color font-14" data-bs-toggle="modal" data-bs-target="#changePassword">تغيير</a>
                            </span>
                        </div>
                    </div>
                </div>
