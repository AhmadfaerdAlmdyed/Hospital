...
<div class="body-content hospital-details-page">
        ...
        <div class="row mt-4">
            <div class="col-lg-9">
                ...
                <div data-bs-spy="scroll" data-bs-target="#cs-tabs" data-bs-offset="0" class="scrollspy-example" tabindex="0">
                    ...
                    <div id="list-item-4" class="tab-section">
                        ...
                        <figure class="map">
                            <img src="{{ asset('frontend/images/Location.png') }}" alt="" srcset="">
                        </figure>
                    </div>
            ...
            <div class="col-lg-3">
                <div class="form-hospital">
                    ...
                    <form action="{{ route('index.consulting',$hospital->id)}}" method="POST"> 
                     ...
                     @endif     
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control cs-input" name="name" id="" placeholder="الاسم كاملا">
                            <span > @error('name')  {{$message}}   @enderror </span>
                        </div>
                        <div class="form-group mb-2">
                            <label for="">البريد الالكتروني</label>
                            <input type="email" class="form-control cs-input" name="email" id="" placeholder="البريد الالكتروني">
                            <span > @error('email')  {{$message}}   @enderror </span>
                        </div>
                        <div class="form-group mb-2">
                            <label for="">رقم الجوال</label>
                            <input type="text" class="form-control cs-input" name="phone" id="phone" placeholder="رقم الجوال">
                            <span > @error('phone')  {{$message}}   @enderror </span>
                        </div>
                        <div class="form-group mb-2">
                            <label for="">التخصص</label>
                        <select name="major_id" id="" class="form-select cs-input">
                            @foreach ($majors as $major)
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control cs-input" name="illness" id="" placeholder="ادخل المرض">
                            <span > @error('illness')  {{$message}}   @enderror </span>
                        </div>
                        <div class="form-group mb-2">
                            <label for="">الوصف</label>
                            <textarea name="descrption" id="" class="form-control cs-input" cols="30" rows="5" placeholder="ادخل وصف مختصر..."></textarea>
                            <span > @error('descrption')  {{$message}}   @enderror </span>
                        </div>
                        ...
                        <button type="submit" class="btn cs-btn v2 w-100 mt-4">أرسل الطلب</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="other-hospitals">
        ...
        <div class="container">
            <div class="row mt-5">
                @foreach ($hospitals->take(6) as $hospitals)
